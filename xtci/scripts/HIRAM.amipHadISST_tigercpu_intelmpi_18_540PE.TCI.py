...
for en in ens:
    print(f'en = {en:02d}' )
    idir = f'/tigress/{exp_user}/MODEL_OUT/{model}/{expname}/en{en:02d}'
    odir = f'/tigress/{analysis_user}/MODEL_OUT/{model}/{expname}/en{en:02d}/analysis_wy/TCI'
